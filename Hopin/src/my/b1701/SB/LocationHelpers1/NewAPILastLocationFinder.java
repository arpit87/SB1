 ...
 */
@SuppressLint("NewApi")
public class NewAPILastLocationFinder implements ILastLocationFinder {
  
  protected static String TAG = "LastLocationFinder";
  protected static String SINGLE_LOCATION_UPDATE_ACTION = "SINGLE_LOCATION_UPDATE_ACTION";
   ...
   */
  public NewAPILastLocationFinder(Context context) {
    this.context = context;
    locationManager = (LocationManager)context.getSystemService(Context.LOCATION_SERVICE);
    singleUpdateReceiver = new LocationUpdaterFromIntent();
